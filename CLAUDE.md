...
- **Admin Dashboard**: `https://rightful-rabbit-333.convex.site/adminDashboard?key=safetube-admin-2024`
...
```bash
curl "https://rightful-rabbit-333.convex.site/setSubscriptionStatus?email=user@example.com&status=active&key=IscYPRsiaDdpuN378QS5tEvp2uCT%2BUHPyHpZG6lVko4%3D"
...
```bash
STRIPE_SECRET_KEY=sk_live_51RtgcnKgkIT46sg7...
STRIPE_WEBHOOK_SECRET=whsec_TmVFD6DJu8kaFLtZ13RPDwu5jcNMaugP
