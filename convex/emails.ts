  ...
  handler: async (ctx, args) => {
    ...
    try {
      ...
      const adminResult = await resend.emails.send({
        ...
        to: process.env.ADMIN_EMAIL || 'jeremiah@getsafetube.com',
    ...
    try {
      ...
      const userResult = await resend.emails.send({
        ...
        replyTo: "jeremiah@getsafetube.com",
        to: args.userEmail,
    ...
    const emailContent = `
      ...
      <html>
        ...
        <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="text-align: center; padding-top: 24px; border-top: 1px solid #e5e7eb;">
            <p style="color: #6b7280; font-size: 14px; margin: 0 0 8px 0;">
              Questions? Contact us at <a href="mailto:jeremiah@getsafetube.com" style="color: #dc2626; text-decoration: none;">jeremiah@getsafetube.com</a>
            </p>
            <p style="color: #9ca3af; font-size: 12px; margin: 0;">
              The SafeTube Team
            </p>
...
export const sendSubscriptionConfirmation = action({
  ...
  handler: async (ctx, args) => {
    ...
    const emailContent = args.subscriptionType === "trial" ? `
      ...
      <p>Questions? Reply to this email or contact us at jeremiah@getsafetube.com</p>
